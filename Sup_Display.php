            ...
            <div class="container-fluid pt-4 px-4 mb-2 pb-3">
                <div class="row vh-auto bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-11 text-center">
                        <h3 style="margin-top: 4%;">Supplier List</h3>
                        <div 
                            style="display:flex; justify-content: flex-end; margin-top: 15px; margin-bottom: 20px;  ">
                            <form action="Sup_conn_db.php" method="post">
                            <button 
                                type="submit" 
                                id="intborder" 
                                name="createFromDisplay" 
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <td style="text-align:center;">
                                        <a href="' . $SupWebsite . '" target="_blank" style="color:"blue""><i class="fa fa-link" style="color:#22769D" aria-hidden="true"></i></a>
                                    </td>
                                    <td>' . $SupMobile . '</td>
                                    <td>
                                    <a href="Sup_update.php?updateid=' . $SupID . '" class="text-white"><button type="button" class="btn btn-success m-2">Update</button></a>
                                    <a href="Sup_delete.php?deleteid=' . $SupID . '"><button type="button" class="btn btn-outline-danger m-2"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
