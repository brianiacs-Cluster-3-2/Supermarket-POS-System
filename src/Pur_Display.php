            ...
            <div class="container-fluid pt-4 px-4 mb-2 pb-3">
                <div class="row vh-auto bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-11 text-center">
                        ...
                        <h3 style="margin-top: 4%;">Purchase List</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $sql = "SELECT * FROM `purchase` ORDER BY PurID ASC";
                                    ...
                                    <td>' . $ItemTotal . '</td>
                                    <td>
                                    <a href="Pur_update.php?updateid=' . $PurID . '" class="text-white"><button type="button" class="btn btn-success m-2">Update</button></a>
                                    <a href="Pur_delete.php?deleteid=' . $PurID . '"><button type="button" class="btn btn-outline-danger m-2"><i class="fa fa-trash" aria-hidden="true"></i></button></a>
                                ...
                                <div class="bg-secondary rounded-top p-4">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 text-center text-sm-start">
                                            &copy; <a href="#" style="color:#f39c12">Brainiacs' POS System</a>, All
                                            Right Reserved.
                                        </div>
                                        <div class="col-12 col-sm-6 text-center text-sm-end">
                                            ...
                                            <br>Distributed By: <a href="" target="_blank"
