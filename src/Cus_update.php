                 ...
                 <h3>Update Customer</h3>
                            <form method="post" class="form">
                                    ...
                                    <div id="lab">
                                        ...
                                        <input id="intborder"  disabled value="<?php echo $CusID ?>" style="background-color: #2F2F2F;" type="text" class="form-control" name="CusID" placeholder="ID">
                                    </div>
                                    <div id="lab">
                                        <label for="CusName">Customer Name</label>
                                        <input id="intborder" value="<?php echo $CusName ?>" type="text" class="form-control" name="CusName" placeholder="Customer Name">
                                    </div>
                                    <div id="lab">
                                        <label for="CusAddress">Address</label>
                                        <input id="intborder" value="<?php echo $CusAddress ?>" type="text" class="form-control" name="CusAddress" placeholder="Customer Address">
                                    </div>
                                <div id="lab">
                                    <label for="CusBalanace">Balanace</label>
                                    <input id="intborder" value="<?php echo $CusBalanace ?>" type="number" step="0.01" class="form-control" name="CusBalanace" placeholder="0.00">
                                </div>

                                <div id="lab">
                                    <label for="CusEmail">Email</label>
                                    <input id="intborder" value="<?php echo $CusEmail ?>" type="email" class="form-control" name="CusEmail" placeholder="Customer Email">
                                </div>

                                <div id="lab">
                                    <label for="CusMobile">Mobile</label>
                                    <input id="intborder" value="<?php echo $CusMobile ?>" type="tel" class="form-control" name="CusMobile" placeholder="Customer Mobile">
                                </div>

                                <button type="submit" id="intborder" name="create" class="btn btn-primary" style="background-color: #f39c12;">UPDATE</button>
                            </form>
