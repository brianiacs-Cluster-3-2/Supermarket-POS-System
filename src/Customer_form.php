...
<?php
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-auto bg-secondary pb-4 rounded px-3 pt-4 d-flex align-items-center justify-content-center mx-0">       
                        <h3>Create Customer</h3>
                            <form method="post" action="Cus_conn_db.php" class="form">
                                <div id="lab">
                                        <label for="CusName">Emplyee ID</label>
                                        <input id="intborder" type="text" class="form-control" name="empID" placeholder="Customer Name">
                                    </div>
                                    <div id="lab">
                                        <label for="CusName">Customer Name</label>
                                        <input id="intborder" type="text" class="form-control" name="CusName" placeholder="Customer Name">
                                    </div>
                                    <div id="lab">
                                        <label for="CusAddress">Address</label>
                                        <input id="intborder" type="text" class="form-control" name="CusAddress" placeholder="Customer Address">
                                    </div>
                                <div id="lab">
                                    <label for="CusBalanace">Balanace</label>
                                    <input id="intborder" type="number" class="form-control" name="CusBalanace" placeholder="0.00">
                                </div>

                                <div id="lab">
                                    <label for="CusEmail">Email</label>
                                    <input id="intborder" type="email" class="form-control" name="CusEmail" placeholder="Customer Email">
                                </div>

                                <div id="lab">
                                    <label for="CusMobile">Mobile</label>
                                    <input id="intborder" type="tel" class="form-control" name="CusMobile" placeholder="Customer Mobile">
                                </div>
                                <button type="submit" id="intborder" name="create" class="btn btn-primary" style="background-color: #f39c12;">CREATE</button>
                            </form>
    ...
    ?>
       ...
       <?php
            ...
            include('C:/xampp/htdocs/OUSL/Project/src/Employee/newCustomer.php');
        }
        ?>
