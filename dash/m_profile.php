    ...
    <body>
        <div class="container-fluid position-relative d-flex p-0">
            ...
            <div class="content">
                ...
                <div class="col-sm-12 col-xl-12" style="height: 600px;">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h3 class="mb-4">My Profile</h3>
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="./img/my.jpg" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1">J Akthar Farvees</h5>
                                    <p>Software Engineer (Fullstack.Dev)</p>
