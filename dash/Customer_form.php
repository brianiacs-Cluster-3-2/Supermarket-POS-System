                ...
                <div class="row vh-100 bg-secondary pt-4  justify-content-center mx-0 ">
                    <div>
                        ...
                        <div class="Buisness_info">
                            <form method="post" action="Cus_conn_db.php">
                                <div class="form-row">
                                        <!-- <div class="lab">
                                            <label for="CusID">ID</label>
                                            <input id="intborder"  type="text" class="form-control" name="CusID" placeholder="ID" style="width: 50%; ">
                                        </div> -->
                                    <div class="lab">
                                        <label for="CusName">Customer Name</label>
                                        <input id="intborder" type="text" class="form-control" name="CusName" placeholder="Customer Name" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="CusAddress">Address</label>
                                        <input id="intborder" type="text" class="form-control" name="CusAddress" placeholder="Customer Address" style="width: 50%;">
                                    </div>
                                </div>
                                <div class="lab">
                                    <label for="CusBalanace">Balanace</label>
                                    <input id="intborder" type="number" class="form-control" name="CusBalanace" placeholder="0.00" style="width: 50%;">
                                </div>

                                <div class="lab">
                                    <label for="CusEmail">Email</label>
                                    <input id="intborder" type="email" class="form-control" name="CusEmail" placeholder="Customer Email" style="width: 50%;">
                                </div>

                                <div class="lab">
                                    <label for="CusMobile">Mobile</label>
                                    <input id="intborder" type="tel" class="form-control" name="CusMobile" placeholder="Customer Mobile" style="width: 50%;">
                                </div>
                                ...
                                <button type="submit" id="intborder" name="create" class="btn btn-primary" style="margin-top: -14%;width: 20%; background-color: #f39c12;">CREATE</button>
                            </form>
                        </div>
