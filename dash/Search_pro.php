                ...
                <div class="row vh-100 bg-secondary pt-4  justify-content-center mx-0 ">
                    <center>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="lab">
                                <input id="intborder" type="text" class="form-control" name="id" placeholder="Enter ID To Search" style="width: 50%; background-color:black;">
                            </div>
                            <div class="lab">
                                <input id="intborder" type="submit" class="form-control" name="search" value="Search" style="width: 50%; background-color:#f39c12; color: white">
                            </div>
                        </form>
                        ...
                        ?>
                                    ...
                                    <form action="" method="POST">
                                        <input disabled id="intborder" type="hidden" class="form-control" name="ProID" style="width: 50%;" value="<?php echo $row['ProID'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="SupID" style="width: 50%;" value="<?php echo $row['SupID'] ?>">
                                        <input  disabled id="intborder" type="text" class="form-control" name="SupName" style="width: 50%;" value="<?php echo $row['SupName'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="ProName" style="width: 50%;" value="<?php echo $row['ProName'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="ProPurchasePrice" style="width: 50%;" value="<?php echo $row['ProPurchasePrice'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="ProSalePrice" style="width: 50%;" value="<?php echo $row['ProSalePrice'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="ProStock" style="width: 50%;" value="<?php echo $row['ProStock'] ?>">
                                        <input disabled id="intborder" type="text" class="form-control" name="ProPerPack" style="width: 50%;" value="<?php echo $row['ProPerPack'] ?>">

                                        
                                            <a href="Search_pro.php"><input id="intborder" type="button" class="form-control" name="Clear" value="Clear" style="width: 15%; background-color:red; color: white"/></a>
