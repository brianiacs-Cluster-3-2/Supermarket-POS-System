    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <h3  style="color:#f39c12; margin-left:-10px"><img src="./img/logo.png" style="width:40px ; height:40px" alt="logo"> Brainiacs' POS</h3></h3>
                </a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-secondary rounded pt-4 justify-content-center mx-0">
                    <div>
                        <h3>My Business Info</h3>

                        <div class="Buisness_info">
                            <form method="post" action="conn_db.php">
                                <div class="form-row">
                                    <div class="lab">
                                        <label for="BusinessName">Business Name</label>
                                        <input id="intborder" type="text" class="form-control" name="BusinessName" placeholder="Business Name" style="width: 50%; ">
                                    </div>
                                    <div class="lab">
                                        <label for="TagLine">Tag Line</label>
                                        <input id="intborder" type="text" class="form-control" name="TagLine" placeholder="Tag Line" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="BusinessAddress">Business Address</label>
                                        <input id="intborder" type="text" class="form-control" name="BusinessAddress" placeholder="Business Address" style="width: 50%;">
                                    </div>
                                </div>
                                <div class="lab">
                                    <label for="Mobile">Mobile</label>
                                    <input id="intborder" type="tel" class="form-control" name="Mobile" placeholder="+94 777777777" style="width: 50%;">
                                </div>
                                <div class="lab">
                                ...
                                <button type="submit" id="intborder" name="submit" class="btn btn-primary" style="margin-top: 1%;width: 20%; background-color: #f39c12;">UPDATE</button>
                            </form>
                        </div>
