...
if (isset($_POST['create'])) {
    ...
    // SupID=$SupID,
    $sql = "UPDATE `supplier` SET  SupName='$SupName',  SupAddress='$SupAddress' , SupBalanace=$SupBalanace 
    WHERE SupID=$id";
    // $result = ;
                            ...
                            <form method="post">
                                <div class="form-row">
                                    <div class="lab">
                                        ...
                                        <input id="intborder" disabled style="background-color: #2F2F2F; width:50%" value="<?php echo $SupID ?>" type="text" class="form-control" name="SupID" placeholder="ID" style="width: 50%; ">
                                    </div>
                                    <div class="lab">
                                        <label for="SupName">Supplier Name</label>
                                        <input id="intborder" value="<?php echo $SupName ?>" type="text" class="form-control" name="SupName" placeholder="Supplier Name" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="SupAddress">Address</label>
                                        <input id="intborder" value="<?php echo $SupAddress ?>" type="text" class="form-control" name="SupAddress" placeholder="Supplier Address" style="width: 50%;">
                                    </div>

                                </div>
                                <div class="lab">
                                    <label for="SupBalanace">Balanace</label>
                                    <input id="intborder" value="<?php echo $SupBalanace ?>" type="tel" class="form-control" name="SupBalanace" placeholder="0.00" style="width: 50%;">
                                </div>
                                <div class="lab">
