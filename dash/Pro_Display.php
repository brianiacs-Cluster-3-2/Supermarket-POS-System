...
<head>
    <meta charset="utf-8">
    <title>Brainiacs Product List</title>
    ...
    <link href="https://o.remove.bg/downloads/8686edcd-dca1-4986-bf99-38a248c13834/istockphoto-1205419959-612x612-removebg-preview.png" rel="shortcut icon">
    ...
    <link rel="stylesheet" href="../dash/product card popup/css/style.css">

    <!-- custom js file link  -->
    <script src="../dash/product card popup/js/script.js" defer></script>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="blank.php  " class="navbar-brand mx-4 mb-3">
                    <h3 style="color:#f39c12"><img src="./img/logo.png" style="width:37px ; height:37px" alt="logo"> Brainiacs' POS</h3>
                </a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-auto bg-secondary  rounded align-items-center justify-content-center mx-0">
                    ...
                    <a href="product_form.php"><button type="submit" id="intborder" name="create" class="btn btn-primary" style="margin-top: 3%; margin-left: 1.3%; width: 20%; background-color: #f39c12;"> CREATE NEW PRODUCT</button></a>
                            ...
                            <div class="container">
                                ...
                                <div class="products-container">
                                    ...
                                    <div class="product" data-name="p-1">
                                        <img src="../dash/product card popup/images/1.png" alt="">
                                        <h3>strawberries</h3>
                                        <div class="price">$2.00</div>
                                    </div>

                                    <div class="product" data-name="p-2">
                                        <img src="../dash/product card popup/images/2.png" alt="">
                                        <h3>onions</h3>
                                        <div class="price">$2.00</div>
                                    </div>

                                    <div class="product" data-name="p-3">
                                        <img src="../dash/product card popup/images/3.png" alt="">
                                        <h3>tomatoes</h3>
                                        <div class="price">$2.00</div>
                                    </div>

                                    <div class="product" data-name="p-4">
                                        <img src="../dash/product card popup/images/4.png" alt="">
                                        <h3>brinjal</h3>
                                        <div class="price">$2.00</div>
                                    </div>

                                    <div class="product" data-name="p-5">
                                        <img src="../dash/product card popup/images/5.png" alt="">
                                        <h3>broccoli</h3>
                                        <div class="price">$2.00</div>
                                    </div>

                                    <div class="product" data-name="p-6">
                                        <img src="../dash/product card popup/images/6.png" alt="">
                                        <h3>potatoes</h3>
                                        <div class="price">$2.00</div>
                                    </div>
