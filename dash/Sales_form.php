            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row v bg-secondary pt-4  justify-content-center mx-0 " style="padding-bottom: 25px; ">
                    <div>
                        ...
                        <div class="Buisness_info">
                            <form method="post" action="Sup_conn_db.php">
                                <div class="form-row">
                                    <div class="lab">
                                        <label for="SupName">Customer Name</label>
                                    ...
                                    <div class="lab">
                                        ...
                                        <input disabled id="intborder" type="text" class="form-control" name="SupAddress" placeholder="Supplier Address" style="width: 50%; background-color:#2F2F2F;">
                                    </div>
                                </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <th scope="col"><input id="intborder" disabled value="0" type="number" class="form-control" name="ProStock" placeholder="" style="background-color:#2F2F2F;"></th>
                                        <th scope="col"><input type="text" class="form-control" style="border-color:#f39c12"></th>
                                        <th><button type="button" class="btn btn-outline-danger"><i class="fa fa-trash" aria-hidden="true"></i></button></a></th>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div style="text-align:center; margin-top:30px ; background-color:#191C24; padding-top:0; margin-top:0; padding-bottom:25px">
                        <button type="submit" id="" name="save & print" class="btn btn-primary" style="width: 20%; background-color: #f39c12;">Save & Print</button>
                    </div>
