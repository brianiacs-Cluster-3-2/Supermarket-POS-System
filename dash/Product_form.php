    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-auto bg-secondary pt-4  justify-content-center mx-0 ">
                    <div>
                        ...
                        <div class="Buisness_info">
                            ...
                            <form action="" method="POST">
                                <div class="lab">
                                    <input id="intborder" type="text" class="form-control" name="id" placeholder="First You Should Find The Supplier" style="width: 50%; background-color:black;">
                                </div>
                                <div class="lab">
                                    <input id="intborder" type="submit" class="form-control" name="search" value="Check" style="width: 50%; background-color:#f39c12; color: white">
                                </div>
                            </form>
                            <?php
                            ...
                            ?>
                                        <form action="" method="POST">
                                            <table>
                                                <tr>
                                                    <td>
                                            <input disabled  id="intborder" type="text" class="form-control" name="SupName" style="width: 170%; background-color:#2F2F2F; color:white; margin-bottom:40px" value="<?php  echo "Supplier is:  ", $row['SupName']?>"/>
                                            </td>
                                            <td>
                                                <div style="
                                            ...
                                            style="
                                            color:white; height:50px; margin-top:13px;margin-left:10px"
                                            ></i>
                                            </div>
                                            <!-- <input disabled  type="text" class="form-control" name="SupID" style="width: 100%; background-color:#008000; color:white; margin-bottom:40px" value="Pass"/> -->
                                            </td>    
                                        </tr>    
                                        </table>
                                        </form>

                                        <form method="post" action="Pro_conn_db.php">
                                <div class="form-row">

                                    <div class="lab">
                                        <label for="SupID">Supplier ID</label>
                                        <input id="intborder" type="number" class="form-control" name="SupID" placeholder="SupID" style="width: 50%;">
                                    </div>   

                                    <div class="lab">
                                        <label for="ProName">Product Name</label>
                                        <input id="intborder" type="text" class="form-control" name="ProName" placeholder="Product Name" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="ProPurchasePrice">Purchase Price</label>
                                        <input id="intborder" type="number" class="form-control" name="ProPurchasePrice" placeholder="0.00" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="ProSalePrice">Sale Price</label>
                                        <input id="intborder" type="number" class="form-control" name="ProSalePrice" placeholder="0.00" style="width: 50%;">
                                    </div>
                                </div>
                                <div class="lab">
                                    <label for="ProStock">Stock</label>
                                    <input id="intborder" disabled value="0.00" type="number" class="form-control" name="ProStock" placeholder="0.00" style="background-color:#2F2F2F; width: 50%;">
                                </div>

                                <div class="lab">
                                    <label for="ProPerPack">Per pack (at least 1)</label>
                                    <input id="intborder" type="Number" value="1" class="form-control" name="ProPerPack" placeholder="Per pack" style="width: 50%;">
                                </div>

                                <div class="lab">
                                    <label for="ProStock">Image</label>
                                    <input id="intborder" value="Insert product image" type="file" class="form-control" name="image" style="background-color:#2F2F2F; width: 50%;">
                                </div>
                                ...
                                margin-top: 4%; 
                                margin-bottom: 4%; 
                                width: 20%; background-color: #f39c12;">CREATE</button>
                            </form>
