            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-auto bg-secondary  rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        ...
                        <h3 style="margin-top: 4%; margin-left: -170%;">Purchase List</h3>

                        <a href="Purchase_form.php"><button type="submit" id="intborder" name="create" class="btn btn-primary" style="margin-top: 5%; margin-bottom: 5%; margin-left: -140%; width: 32%; background-color: #f39c12;"> Add new purchase</button></a>
                        </div
                        </div
                        </div
