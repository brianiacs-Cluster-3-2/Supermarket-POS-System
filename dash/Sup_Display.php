            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-auto bg-secondary  rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center">
                        ...
                        <h3 style="margin-top: 4%; margin-left: -170%;">Suppliers List</h3>

                        <a href="Supplier.php"><button type="submit" id="intborder" name="create" class="btn btn-primary" style="margin-top: 5%; margin-left: -140%; width: 20%; background-color: #f39c12;"> CREATE</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <td>' . $SupBalanace . '</td>
                                                    <td>
                                                    <button type="button" class="btn btn-success m-2"><a href="Sup_update.php?updateid='.$SupID.'" class="text-white">Update</a></button>
