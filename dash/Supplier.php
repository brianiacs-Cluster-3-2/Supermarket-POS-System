                ...
                <div class="row vh-100 bg-secondary pt-4  justify-content-center mx-0 ">
                    <div>
                        ...
                        <div class="Buisness_info">
                            <form method="post" action="Sup_conn_db.php" action="Pro_conn_db.php">
                                <div class="form-row">
                                    <div class="lab">
                                        <label for="SupID">ID</label>
                                        <input id="intborder" type="text" class="form-control" name="SupID" placeholder="ID" style="width: 50%; ">
                                    </div>
                                    <div class="lab">
                                        <label for="SupName">Supplier Name</label>
                                        <input id="intborder" type="text" class="form-control" name="SupName" placeholder="Supplier Name" style="width: 50%;">
                                    </div>
                                    <div class="lab">
                                        <label for="SupAddress">Address</label>
                                        <input id="intborder" type="text" class="form-control" name="SupAddress" placeholder="Supplier Address" style="width: 50%;">
                                    </div>
                                </div>
                                <div class="lab">
                                    <label for="SupBalanace">Balanace</label>
                                    <input id="intborder" type="tel" class="form-control" name="SupBalanace" placeholder="0.00" style="width: 50%;">
                                </div>
                                <div class="lab">
